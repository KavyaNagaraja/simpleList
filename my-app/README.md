...
upon clicking list item , respective bacground color should change to green
...
I have fixed the component as much as possible . please run the same by using npm start
